...
export const projects: Project[] = [
  makeProject('p-1', 'Modern Minimalist Villa', 'modern-minimalist-villa', 'residential', 'A complete interior and exterior transformation of a luxury villa in DHA Phase 6. Used premium Gobis emulsion with custom color matching for a sleek, modern aesthetic.', 'Ahmed & Sara Khan', 'DHA Phase 6, Lahore', '2025-10-15', ['Gobis Silk Emulsion', 'Shield Coat Exterior'], 0),
  ...
  makeProject('p-3', 'Luxury Apartment Complex', 'luxury-apartment-complex', 'residential', 'Painting of 48 luxury apartments with consistent premium finish throughout. Each apartment featured a unique accent wall design.', 'Heights Developers', 'Gulberg III, Lahore', '2025-08-10', ['Gobis Weather Shield', 'ALI Premium Interior'], 2),
  ...
  makeProject('p-5', 'Boutique Hotel Interior', 'boutique-hotel-interior', 'commercial', 'Luxurious texture painting and wood polishing for a boutique hotel. Included metallic accent walls and premium wood finish for all furniture.', 'Pearl Hospitality', 'Mall Road, Lahore', '2025-06-18', ['Metallic Texture Paint', 'WoodMaster Polish'], 4),
  makeProject('p-6', 'School Campus Exterior', 'school-campus-exterior', 'commercial', 'Complete exterior repainting of a school campus including classrooms, sports complex, and administration building with weather-resistant coatings.', 'City Grammar School', 'Johar Town, Lahore', '2025-05-12', ['Gobis Weather Shield', 'Shield Coat Plus'], 5),
  makeProject('p-7', 'Farmhouse Retreat', 'farmhouse-retreat', 'residential', 'A rustic yet modern farmhouse transformation using earthy tones and natural wood finishes. Interior and exterior with waterproofing.', 'Malik Family', 'Bedian Road, Lahore', '2025-04-08', ['Gobis Silk Emulsion', 'AquaGuard Waterproofing'], 6),
  makeProject('p-8', 'Food Court & Restaurant', 'food-court-restaurant', 'commercial', 'Vibrant, food-safe coating for a modern food court. Used washable and heat-resistant paints for the kitchen areas.', 'Flavor Street', 'Packages Mall, Lahore', '2025-03-22', ['Washable Emulsion', 'Heat Resistant Coating'], 7),
